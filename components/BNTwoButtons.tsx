...
export default function BNTwoButtons({ showNext, setShowNext }) {
    ...
    <View style={{justifyContent:'flex-end', height:'85%',width:'100%', backgroundColor: "#FFFFFF", borderRadius: 15}}>
        ...
        <View style={{justifyContent: "space-between", flexDirection:'row'}}>
            <View>
                ...
                <Button icon="alpha-x-circle-outline" labelStyle={{ fontSize: 90, color: "#FF0000", }} style={{ backgroundColor: "#FFFFFF",width:100}}></Button>
            </View>
            <View>
                <Image source={require('../assets/images/MANITA_ABAJO.png')} style={{ width: 100, height: 100}}/>
                <Button
                    ...
                    onPress={() => nav.navigate('BNStarButton')}
                ></Button>
